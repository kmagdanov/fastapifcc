...
# Connection to db without sqlalchemy
# while True:
#     try:
#         conn = psycopg2.connect(host='localhost', database='fastapifcc', user='postgres',
#                                 password='serfer16', cursor_factory=RealDictCursor)
#         cursor = conn.cursor()
